...
import { getInnovaVideos } from "../../api/videos";
import './innovaVideos.css';
import Modal from "../modal";
import Card from "../Card";

export default function InnovaVideos() {
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                const frontVideos = await getInnovaVideos();
...
return(
    <div className="contaiback">
        <div className="section-title innova-title">
